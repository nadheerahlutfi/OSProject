...
/dev/root       30298176 22864392   7417400  76% /vscode
/dev/loop3      32847680 13820792  17332792  45% /workspaces
/dev/sdb1       46127956     1440  43750940   1% /tmp__.
6. Run the command **du** . ***(1 mark)*** __Fill answer here__.
7. Run the command **ls** . ***(1 mark)*** __Fill answer here__.
